...
\begin{figure}[h]
\centering
\includegraphics[width=8cm]{figures/figure_one_tss-seq-coverage.pdf}
...
\begin{figure}[h]
\centering
\includegraphics[width=7cm]{figures/figure_three_tfiib-nexus-tata.pdf}
...
\begin{figure}[h]
\centering
\includegraphics[width=17.4cm]{figures/figure_two_tss-seq-heatmaps.pdf}
...
\begin{figure}[h]
\centering
\includegraphics[width=8.7cm]{figures/figure_four_tfiib-heatmaps.pdf}
...
\begin{figure}[h]
\centering
\includegraphics[width=8cm]{figures/figure_five_tss-diffexp-summary.pdf}
\caption{asdf}
...
\begin{figure}[h]
\centering
\includegraphics[width=7cm]{figures/figure_six_tss-expression-levels.pdf}
\caption{asdf}
...
\begin{figure}[h]
\centering
\includegraphics[width=17.4cm]{figures/figure_seven_tss-v-tfiib.pdf}
\caption{asdf}
\end{figure}
